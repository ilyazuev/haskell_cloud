...
data Request=Set ProcessId String Int|Get ProcessId String deriving(Show,Eq,Typeable,Generic)
instance Binary Request
data Response=Ok|Value(Maybe Int)deriving(Show,Eq,Typeable,Generic)
